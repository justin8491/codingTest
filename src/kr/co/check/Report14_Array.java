...
//			jusArr.add(2, "");
			...
			System.out.println("1." + jusNameArr[0] + "(" + priceToArr[0] + ")" + "("
					+ (stockCount[0] != 0 ? stockCount[0] : "재고없음") + ")" + " 2." + jusNameArr[1] + "(" + priceToArr[1]
					+ ")" + "(" + (stockCount[1] != 0 ? stockCount[1] : "재고없음") + ")" + " 3." + jusNameArr[2] + "("
					+ priceToArr[2] + ")" + "(" + (stockCount[2] != 0 ? stockCount[2] : "재고없음") + ")"
					+ " 4.계산 5.금액 투입 ");
			...
			case 6:// 관리자 모드
				...
				System.out.println("1. 음료 변경 2. 음료 재고 변경 3. 음료 가격 변경");
				int adminNum = sc.nextInt();
				switch (adminNum) {
				case 1:
					System.out.println("===========음료변경===========");
				...
				case 2:
					...
					case 3:
						if (selectJusNum > 0) {
							...
							System.err.println("에러입니다. 관리자에게 문의하세요.");
						}
					}
					System.out.println();
					break;
				...
				case 3:
					...
					System.out.println("1." + jusNameArr[0] + "(" + priceToArr[0] + ") 2." + jusNameArr[1] + "("
							+ priceToArr[1] + ") 3." + jusNameArr[2] + "(" + priceToArr[2] + ")");
					selectJusNum = sc.nextInt();
					...
					case 3:
						if (selectJusNum > 0) {
							...
							priceToArr[selectJusNum - 1] = sc.nextInt();
