...
//				for (int i = 0; i < jusArr.size(); i++) {
//
//					if (jusArr.get(i).toString().equals(jusNameArr[i])) {
//						jusCount[i]++;
//					} else {
//						continue;
//					}
...
//				}
				...
				System.out.println(jusNameArr[0] + " " + jusCount[0] + "개");
				System.out.println(jusNameArr[1] + " " + jusCount[1] + "개");
				System.out.println(jusNameArr[2] + " " + jusCount[2] + "개");
				System.out.println("====================");
